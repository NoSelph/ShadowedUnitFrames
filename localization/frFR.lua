...
L["Attached to health bar"] = "Attaché à la barre de vie"
L["Attached to frame"] = "Attaché au cadre"
L["Bar interior"] = "Intérieur de la barre"
L["Percentage value of how far inside the unit frame the absorbed health bar can go. 90% means it will go 10% inside the frame, 50% means it will go up to the middle of the frame."] = "Jusqu'où la barre des soins absorbés peut aller. 90% signifie qu'elle peut aller 10% à l'intérieur du cadre, 50% signifie qu'elle peut aller jusqu'au milieu du cadre."
L["Percentage value of how far inside the unit frame the incoming heal bar can go. 90% means it will go 10% inside the frame, 50% means it will go up to the middle of the frame."] = "Jusqu'où la barre des soins entrants peut aller. 90% signifie qu'elle peut aller 10% à l'intérieur du cadre, 50% signifie qu'elle peut aller jusqu'au milieu du cadre."
L["Percentage value of how far inside the unit frame the incoming absorb bar can go. 90% means it will go 10% inside the frame, 50% means it will go up to the middle of the frame."] = "Jusqu'où la barre des absorptions entrantes peut aller. 90% signifie qu'elle peut aller 10% à l'intérieur du cadre, 50% signifie qu'elle peut aller jusqu'au milieu du cadre."
...
L["Bar anchored to the right edge of the frame, growing inward with reverse fill."] = "Barre ancrée au bord droit du cadre, grandissant vers l'intérieur avec remplissage inversé."
...
L["Bar anchored to the end of the health bar, growing outward (uses overflow limit)."] = "Barre ancrée à la fin de la barre de vie, grandissant vers l'extérieur (utilise la limite de dépassement)."
L["Bar anchored to the right edge of the frame, growing inward with reverse fill."] = "Barre ancrée au bord droit du cadre, grandissant vers l'intérieur avec remplissage inversé."
L["Frame coverage"] = "Couverture du cadre"
L["Maximum percentage of the health bar frame that this bar can cover when using frame anchor mode."] = "Pourcentage maximum du cadre de la barre de vie que cette barre peut couvrir en mode ancré au cadre."
