...
L["The \"%s\" option is ignored for zone assignments; select the filter directly in a unit's Auras tab to use it."] = "Параметр \"%s\" не действует для назначений по зонам; чтобы использовать его, выберите фильтр непосредственно во вкладке аур юнита."
