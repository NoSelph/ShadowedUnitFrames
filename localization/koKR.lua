...
L["Text/Tags"] = "텍스트/태그"
L["The \"%s\" option is ignored for zone assignments; select the filter directly in a unit's Auras tab to use it."] = "\"%s\" 옵션은 지역 할당에는 적용되지 않습니다. 사용하려면 유닛의 오라 탭에서 필터를 직접 선택하세요."
