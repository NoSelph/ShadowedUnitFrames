...
L["Attached to health bar"] = "Attached to health bar"
L["Attached to frame"] = "Attached to frame"
L["Frame coverage"] = "Frame coverage"
...
L["Bar anchored to the right edge of the frame, growing inward with reverse fill."] = "Bar anchored to the right edge of the frame, growing inward with reverse fill."
L["Maximum percentage of the health bar frame that this bar can cover when using frame anchor mode."] = "Maximum percentage of the health bar frame that this bar can cover when using frame anchor mode."
...
L["Bar anchored to the end of the health bar, growing outward (uses overflow limit)."] = "Bar anchored to the end of the health bar, growing outward (uses overflow limit)."
L["Bar anchored to the right edge of the frame, growing inward with reverse fill."] = "Bar anchored to the right edge of the frame, growing inward with reverse fill."
L["Bar interior"] = "Bar interior"
L["Percentage value of how far inside the unit frame the absorbed health bar can go. 90% means it will go 10% inside the frame, 50% means it will go up to the middle of the frame."] = "Percentage value of how far inside the unit frame the absorbed health bar can go. 90% means it will go 10% inside the frame, 50% means it will go up to the middle of the frame."
L["Percentage value of how far inside the unit frame the incoming heal bar can go. 90% means it will go 10% inside the frame, 50% means it will go up to the middle of the frame."] = "Percentage value of how far inside the unit frame the incoming heal bar can go. 90% means it will go 10% inside the frame, 50% means it will go up to the middle of the frame."
L["Percentage value of how far inside the unit frame the incoming absorb bar can go. 90% means it will go 10% inside the frame, 50% means it will go up to the middle of the frame."] = "Percentage value of how far inside the unit frame the incoming absorb bar can go. 90% means it will go 10% inside the frame, 50% means it will go up to the middle of the frame."
